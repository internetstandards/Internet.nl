...
# Release task-local result consumers when gevent tasks finish.
CELERY_OVERRIDE_BACKENDS = {
    "redis": "internetnl.celery_backend.TaskLocalRedisBackend",
    "rediss": "internetnl.celery_backend.TaskLocalRedisBackend",
}
