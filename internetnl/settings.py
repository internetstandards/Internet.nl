...
CELERY_BATCH_TASK_ROUTES = {
    ...
    "checks.tasks.tls.tasks_reports.batch_web_cert": {"queue": "batch_main"},
    "checks.tasks.tls.tasks_reports.batch_web_conn": {"queue": "batch_main"},
    "checks.tasks.tls.tasks_reports.batch_web_http": {"queue": "batch_main"},
