...
# Do not share the Redis result backend between gevent greenlets. Sharing the
# backend can make multiple greenlets read from the same pubsub socket
# concurrently, causing gevent ConcurrentObjectUseError and failed Celery
# chord/group tasks.
...
RESOLVER_INTERNAL_VALIDATING = "resolver-validating"
