...
CELERY_BATCH_TASK_ROUTES = {
    "checks.tasks.dnssec.batch_mail_callback": {"queue": "batch_callback_dnssec_batch_mail_callback"},
    "checks.tasks.dnssec.batch_mail_is_secure": {"queue": "batch_main_dnssec_batch_mail_is_secure"},
    "checks.tasks.dnssec.batch_web_callback": {"queue": "batch_callback_dnssec_batch_web_callback"},
    "checks.tasks.dnssec.batch_web_is_secure": {"queue": "batch_main_dnssec_batch_web_is_secure"},
    "checks.tasks.ipv6.batch_mail_callback": {"queue": "batch_callback_ipv6_batch_mail_callback"},
    "checks.tasks.ipv6.batch_mx": {"queue": "batch_main_ipv6_batch_mx"},
    "checks.tasks.ipv6.batch_ns": {"queue": "batch_main_ipv6_batch_ns"},
    "checks.tasks.ipv6.batch_web": {"queue": "batch_main_ipv6_batch_web"},
    "checks.tasks.ipv6.batch_web_callback": {"queue": "batch_callback_ipv6_batch_web_callback"},
    "checks.tasks.mail.batch_dkim": {"queue": "batch_main_mail_batch_dkim"},
    "checks.tasks.mail.batch_dmarc": {"queue": "batch_main_mail_batch_dmarc"},
    "checks.tasks.mail.batch_mail_callback": {"queue": "batch_callback_mail_batch_mail_callback"},
    "checks.tasks.mail.batch_spf": {"queue": "batch_main_mail_batch_spf"},
    "checks.tasks.shared.batch_mail_get_servers": {"queue": "batch_main_shared_batch_mail_get_servers"},
    "checks.tasks.shared.batch_resolve_a_aaaa": {"queue": "batch_main_shared_batch_resolve_a_aaaa"},
    "checks.tasks.tls.batch_mail_callback": {"queue": "batch_callback_tls_batch_mail_callback"},
    "checks.tasks.tls.batch_mail_smtp_starttls": {"queue": "batch_main_tls_batch_mail_smtp_starttls"},
    "checks.tasks.tls.batch_web_callback": {"queue": "batch_callback_tls_batch_web_callback"},
    "checks.tasks.tls.batch_web_cert": {"queue": "batch_nassl_tls_batch_web_cert"},
    "checks.tasks.tls.batch_web_conn": {"queue": "batch_nassl_tls_batch_web_conn"},
    "checks.tasks.tls.batch_web_http": {"queue": "batch_main_tls_batch_web_http"},
    "checks.tasks.appsecpriv.batch_web_appsecpriv": {"queue": "batch_main_appsecpriv_batch_web_appsecpriv"},
    "checks.tasks.appsecpriv.batch_web_callback": {"queue": "batch_callback_appsecpriv_batch_web_callback"},
    "checks.tasks.rpki.batch_mail_callback": {"queue": "batch_callback_rpki_batch_mail_callback"},
    "checks.tasks.rpki.batch_mail_ns_rpki": {"queue": "rpki_worker_rpki_batch_mail_ns_rpki"},
    "checks.tasks.rpki.batch_mail_mx_ns_rpki": {"queue": "rpki_worker_rpki_batch_mail_mx_ns_rpki"},
    "checks.tasks.rpki.batch_mail_rpki": {"queue": "rpki_worker_rpki_batch_mail_rpki"},
    "checks.tasks.rpki.batch_ns_rpki": {"queue": "rpki_worker_rpki_batch_ns_rpki"},
    "checks.tasks.rpki.batch_web_callback": {"queue": "batch_callback_rpki_batch_web_callback"},
    "checks.tasks.rpki.batch_web_rpki": {"queue": "rpki_worker_rpki_batch_web_rpki"},
    "interface.batch.util.batch_async_generate_results": {"queue": "batch_slow_util_batch_async_generate_results"},
    "interface.batch.util.batch_async_register": {"queue": "batch_slow_util_batch_async_register"},
    "interface.batch.scheduler.run": {"queue": "batch_scheduler_scheduler_run"},
}
