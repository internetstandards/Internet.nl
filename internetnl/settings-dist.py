...
CELERY_BATCH_TASK_ROUTES = {
    ...
    "checks.tasks.rpki.batch_mail_ns_rpki": {"queue": "batch_main"},
    "checks.tasks.rpki.batch_mail_mx_ns_rpki": {"queue": "batch_main"},
    "checks.tasks.rpki.batch_mail_rpki": {"queue": "batch_main"},
    "checks.tasks.rpki.batch_ns_rpki": {"queue": "batch_main"},
    "checks.tasks.rpki.batch_web_callback": {"queue": "batch_callback"},
    "checks.tasks.rpki.batch_web_rpki": {"queue": "batch_main"},
