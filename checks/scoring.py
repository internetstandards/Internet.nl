...
# NOTICE keeps this non-mandatory: no score impact. To penalise, set WORST_STATUS to
# STATUS_FAIL and return BAD for non-support in TLSPqKexEvaluation.score.
WEB_TLS_PQ_KEX_GOOD = FULL_WEIGHT_POINTS
WEB_TLS_PQ_KEX_BAD = NO_POINTS
WEB_TLS_PQ_KEX_WORST_STATUS = STATUS_NOTICE
