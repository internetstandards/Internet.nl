...
subdomains="nl.$domain,en.$domain,www.$domain"
if [ "$ENABLE_BATCH" != True ]; then
  subdomains="$subdomains,ipv6.$domain,nl.ipv6.$domain,en.ipv6.$domain,conn.$domain,en.conn.$domain,nl.conn.$domain,www.conn.$domain,conn.ipv6.$domain,en.conn.ipv6.$domain,nl.conn.ipv6.$domain,www.conn.ipv6.$domain"
fi
