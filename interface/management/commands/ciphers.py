...
from checks.tasks.cipher_info import CipherScoreAndSecLevel, load_cipher_info
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for ci in cipher_infos.values():
            ...
            if v_level > 2:
                formatted_score = CipherScoreAndSecLevel.format_score(CipherScoreAndSecLevel.calc_cipher_score(ci))
